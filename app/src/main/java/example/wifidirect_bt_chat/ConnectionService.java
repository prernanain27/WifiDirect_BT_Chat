...
import static edu.csulb.hw_5.Constants.MSG_BROKEN_CONN;
import static edu.csulb.hw_5.Constants.MSG_FINISH_CONNECT;
import static edu.csulb.hw_5.Constants.MSG_NEW_CLIENT;
import static edu.csulb.hw_5.Constants.MSG_NULL;
import static edu.csulb.hw_5.Constants.MSG_PULLIN_DATA;
import static edu.csulb.hw_5.Constants.MSG_PUSHOUT_DATA;
import static edu.csulb.hw_5.Constants.MSG_REGISTER_ACTIVITY;
import static edu.csulb.hw_5.Constants.MSG_SELECT_ERROR;
import static edu.csulb.hw_5.Constants.MSG_STARTCLIENT;
import static edu.csulb.hw_5.Constants.MSG_STARTSERVER;
    ...
    private void processIntent(Intent intent){
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {  // this devices's wifi direct enabled state.
            ...
            if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                ...
                mApp.mP2pChannel = mApp.mP2pMan.initialize(this, mWorkHandler.getLooper(), null);
                Preferences_application.setStringToPref(mApp, Preferences_application.PREF_NAME, Preferences_application.P2P_ENABLED, "1");
                ...
                Preferences_application.setStringToPref(mApp, Preferences_application.PREF_NAME, Preferences_application.P2P_ENABLED, "0");
            }
